...
output: 
  officedown::rdocx_document:
    reference_docx: "../templates/newqsc.docx"
    page_margins:
      bottom: 0.5
      top: 0.5
      right: 0.5
    ...
    page_size:
      ...
      height: 11
      orient: "portrait"
#    reference_docx: "/Library/Frameworks/R.framework/Versions/4.1/Resources/library/qsctemplates/rmarkdown/templates/qsc_docx/resources/qsc_docx.docx"
#    mapstyles:
#      Normal: ['First Paragraph']

knit: pgreportr::knit_docx_with_datestamp

# Markdown parameters. You can specify a REDCap export file (.r or .csv pair) or a
...
#  grants_submitted %>% filter_grants_esi_related() %>% expand_investigators(cols=investigators) %>%
#                                filter(is_esi_investigator(`Partnership Role`)),
