...
title:  "PHSU-MCC U54 Grant Report - Year to Date"
author: ""
output: 
  officedown::rdocx_document:
    ...
    reference_docx: "../../u54-report/skeleton/u54_docx.docx"
    page_margins:
      bottom: 0.5
      top: 0.5
      right: 0.5
...
knit: pgreportr::knit_docx_with_datestamp_shiny
...
if ( params$download_from_server ) {
  ...
  dir.create(here::here("data","cached_grants.rds"), showWarnings = FALSE)
...
create_grant_bar_chart <- function(.x, tags, wrap=15) {
  ...
  grant_color_table <- tibble::tribble(
    ...
    "submissions not funded", TRUE, "#d7191c",
    "submissions not funded", FALSE, "#fee0d2",
    "submissions pending", TRUE, "#fecc5c",
    "submissions pending", FALSE, "#fff7bc",
    "grants funded", TRUE, "#a6d96a",
